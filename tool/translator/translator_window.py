...
from qfluentwidgets import Action, InfoLevel, RoundMenu, ToolTipFilter
...
from .widgets.translate_core import TranslateCore
from .widgets.translateapi import Language, API
...
class TranslatorMainWindow(Ui_TranslatorMainWindow, FanWindow):
    ...
    def setPoFileObject(self, poFileObject: PoFileObject):
        ...
        for textObject in poFileObject.getTextList():
            tlw = TextLineWidget()
